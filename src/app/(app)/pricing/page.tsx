  ...
  const plans = [
    {
      ...
      features: [
        ...
        t('pricing.features.up_to_10_recipes'),
        t('pricing.features.inventory'),
        t('pricing.features.reports'),
        t('pricing.features.ai_suggester_limited'),
    ...
    },
    {
      ...
      features: [
        ...
        t('pricing.features.up_to_100_recipes'),
        t('pricing.features.inventory'),
        t('pricing.features.reports'),
        t('pricing.features.ai_suggester_unlimited'),
        t('pricing.features.no_ads'),
      ],
    },
    {
